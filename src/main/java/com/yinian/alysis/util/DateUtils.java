...
public class DateUtils {
	...
	public static int getDayCount(String dt1,String dt2) {
		Date d1 = str2Date(dt1, "yyyy-MM-dd");
		Date d2 =  str2Date(dt2, "yyyy-MM-dd");
		long mm = d2.getTime()-d1.getTime();
		long dd = mm/(60*60*24*1000);
		return Integer.valueOf(dd+"");
	}
	public static void main(String[] args) throws ParseException {
//		System.out.println(getPreviousOrNextDaysOfNow("2018-01-01", 1));
//		System.out.println(getDayCount("2018-01-01", "2018-05-07"));
